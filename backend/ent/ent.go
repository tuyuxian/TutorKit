...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		entattendance.Table: entattendance.ValidColumn,
		entcomment.Table:    entcomment.ValidColumn,
		entcourse.Table:     entcourse.ValidColumn,
		entpost.Table:       entpost.ValidColumn,
		enttodo.Table:       enttodo.ValidColumn,
